...
# Program to calculate lab groups and left-over students
total_students = int(input("How many students? "))
group_size = int(input("Required group size? "))

# Calculating no. of groups and left-over students
num_of_groups = total_students // group_size
left_over_students = total_students % group_size

# Fixing grammar in the output
left_over_student_word = "student" if left_over_students == 1 else "students"

# Displaying output
print(f"There will be {num_of_groups} groups with {left_over_students} {left_over_student_word} left over.")
